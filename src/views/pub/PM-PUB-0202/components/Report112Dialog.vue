...
import { ChildAbuseKey, type Report112Row } from '../composable/PM-PUB-0202'

const store = inject(ChildAbuseKey)!
const { report112DialogOpen, report112Keyword, filtered112Rows, applyReport112 } = store
