  ...
  <GenericDialog2 v-model:open="open" title="범죄예방진단 상세" :size="800" show-close-button>
    ...
    <section :class="styles.dialogSection">
      ...
      <div :class="styles.refTables">
        ...
        <InfoTable :columns="2" popup>
          <InfoField label="인구 밀도"><div :class="styles.referenceValueGrid"><span>보통</span><span>6729</span></div></InfoField>
          <InfoField label="지역 결속력"><div :class="styles.referenceValueGrid"><span>보통</span><span>111</span></div></InfoField>
          <InfoField label="기초생활수급자수"><div :class="styles.referenceValueGrid"><span>보통</span><span>111</span></div></InfoField>
          <InfoField label="1인가구 비율"><div :class="styles.referenceValueGrid"><span>위험</span><span>0</span></div></InfoField>
          <InfoField label="외국인 비율"><div :class="styles.referenceValueGrid"><span>양호</span><span>0</span></div></InfoField>
          <InfoField label="관리대상자수"><div :class="styles.referenceValueGrid"><span>위험</span><span>0</span></div></InfoField>
          <InfoField label="풍속업소 수"><div :class="styles.referenceValueGrid"><span>보통</span><span>173</span></div></InfoField>
          <InfoField label="설문조사 결과"><div :class="styles.referenceValueGrid"><span>보통</span><span>0</span></div></InfoField>
        </InfoTable>
      </div>
    </section>
