...
const worklist = ref([
  ...
  { id: 128, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '목록', depth5: '', screenName: '통신장비 목록', screenId: 'PC-LPO-0704', path: '', status: '대기' },
  { id: 129, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '등록/상세/수정', depth5: '', screenName: '통신장비 등록/상세/수정 팝업창', screenId: 'PC-LPO-0705', path: '', status: '대기' },
  { id: 130, category: '스마트워크', depth1: '', depth2: '', depth3: '무기 탭', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 131, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '목록', depth5: '', screenName: '무기목록', screenId: 'PC-LPO-0706', path: '', status: '대기' },
  { id: 132, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '등록/상세/수정', depth5: '', screenName: '무기 등록/상세/수정 팝업창', screenId: 'PC-LPO-0707', path: '', status: '대기' },
  { id: 133, category: '스마트워크', depth1: '', depth2: '', depth3: '탄약 탭', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 134, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '목록', depth5: '', screenName: '탄약 목록', screenId: 'PC-LPO-0708', path: '', status: '대기' },
  { id: 135, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '등록/상세/수정', depth5: '', screenName: '탄약 등록/상세/수정 팝업창', screenId: 'PC-LPO-0709', path: '', status: '대기' },
  { id: 136, category: '스마트워크', depth1: '', depth2: '', depth3: '수갑 탭', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 137, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '목록', depth5: '', screenName: '수갑 목록', screenId: 'PC-LPO-0710', path: '', status: '대기' },
  { id: 138, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '등록/상세/수정', depth5: '', screenName: '수갑 등록/상세/수정 팝업창', screenId: 'PC-LPO-0711', path: '', status: '대기' },
  { id: 139, category: '스마트워크', depth1: '', depth2: '', depth3: '기타 탭', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 140, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '목록', depth5: '', screenName: '기타 목록', screenId: 'PC-LPO-0712', path: '', status: '대기' },
  { id: 141, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '등록/상세/수정', depth5: '', screenName: '기타 등록/상세/수정 팝업창', screenId: 'PC-LPO-0713', path: '', status: '대기' },
  { id: 142, category: '스마트워크', depth1: '', depth2: '', depth3: '장비 유지보수 이력', depth4: '', depth5: '', screenName: '장비 유지보수 이력 팝업창', screenId: 'PC-LPO-0714', path: '', status: '대기' },
  ...
  { id: 363, category: '스마트워크', depth1: '', depth2: '', depth3: '중요정보 변경이력관리', depth4: '', depth5: '', screenName: '중요정보 변경 이력관리', screenId: 'PC-COM-2301', path: '', status: '대기' },
