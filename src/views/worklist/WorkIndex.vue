...
const worklist = ref([
  ...
  { id: 165, category: '스마트워크', depth1: '', depth2: '', depth3: '우수시설인증', depth4: '리스트', depth5: '', screenName: '진단인증 리스트', screenId: 'PM-PUB-0113', path: '/views/pub/PM-PUB-0113', status: '완료' },
  { id: 166, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '체크리스트', depth5: '', screenName: '진단인증 체크리스트', screenId: 'PM-PUB-0113', path: '/views/pub/PM-PUB-0113', status: '완료' },
  ...
  { id: 290, category: '스마트워크', depth1: '', depth2: '', depth3: '리스트', depth4: '', depth5: '', screenName: '공지사항 리스트 화면', screenId: 'PM-COM-1001', path: '/views/com/PM-COM-1001', status: '완료' },
  { id: 291, category: '스마트워크', depth1: '', depth2: '', depth3: '상세내역', depth4: '', depth5: '', screenName: '공지사항 상세내역 화면', screenId: 'PM-COM-1002', path: '/views/com/PM-COM-1002', status: '완료' },
  { id: 292, category: '스마트워크', depth1: '', depth2: '', depth3: '수정', depth4: '', depth5: '', screenName: '공지사항 수정 화면', screenId: 'PM-COM-1003', path: '/views/com/PM-COM-1003', status: '완료' },
  { id: 293, category: '스마트워크', depth1: '', depth2: '', depth3: '등록', depth4: '', depth5: '', screenName: '공지사항 등록 화면', screenId: 'PM-COM-1004', path: '/views/com/PM-COM-1004', status: '완료' },
  { id: 294, category: '스마트워크', depth1: '', depth2: 'Q&A', depth3: '', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 295, category: '스마트워크', depth1: '', depth2: '', depth3: '리스트', depth4: '', depth5: '', screenName: '장애처리 리스트 화면', screenId: 'PM-COM-1101', path: '/views/com/PM-COM-1101', status: '완료' },
  { id: 296, category: '스마트워크', depth1: '', depth2: '', depth3: '상세내역', depth4: '', depth5: '', screenName: '장애처리 상세내역 화면', screenId: 'PM-COM-1102', path: '/views/com/PM-COM-1102', status: '완료' },
  { id: 297, category: '스마트워크', depth1: '', depth2: '', depth3: '수정', depth4: '', depth5: '', screenName: '수정 화면', screenId: 'PM-COM-1103', path: '/views/com/PM-COM-1103', status: '완료' },
  { id: 298, category: '스마트워크', depth1: '', depth2: '', depth3: '등록', depth4: '', depth5: '', screenName: '등록 화면', screenId: 'PM-COM-1104', path: '/views/com/PM-COM-1104', status: '완료' },
  { id: 299, category: '스마트워크', depth1: '', depth2: '지역경찰 시책 우수사례', depth3: '', depth4: '', depth5: '', screenName: '', screenId: '', path: '', status: '대기' },
  { id: 300, category: '스마트워크', depth1: '', depth2: '', depth3: '리스트', depth4: '', depth5: '', screenName: '지역경찰 시책 우수사례 리스트 화면', screenId: 'PM-COM-1201', path: '/views/com/PM-COM-1201', status: '완료' },
  { id: 301, category: '스마트워크', depth1: '', depth2: '', depth3: '상세내역', depth4: '', depth5: '', screenName: '지역경찰 시책 우수사례 상세내역 화면', screenId: 'PM-COM-1202', path: '/views/com/PM-COM-1202', status: '완료' },
  { id: 302, category: '스마트워크', depth1: '', depth2: '', depth3: '수정', depth4: '', depth5: '', screenName: '지역경찰 시책 우수사례 수정화면', screenId: 'PM-COM-1203', path: '/views/com/PM-COM-1203', status: '완료' },
  { id: 303, category: '스마트워크', depth1: '', depth2: '', depth3: '등록', depth4: '', depth5: '', screenName: '지역경찰 시책 우수사례 등록 화면', screenId: 'PM-COM-1204', path: '/views/com/PM-COM-1204', status: '완료' },
