...
const worklist = ref([
  ...
  { id: 159, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '상세', depth5: '', screenName: '범죄예방진단 상세', screenId: 'PM-PUB-0108', path: '/views/pub/PM-PUB-0107', status: '완료' },
  ...
  { id: 161, category: '스마트워크', depth1: '', depth2: '', depth3: '', depth4: '', depth5: '간이진단통보자료', screenName: '간이진단통보자료', screenId: 'PM-PUB-0109', path: '/views/pub/PM-PUB-0111', status: '완료' },
