...
const worklist = ref([
  ...
  { id: 143, category: '스마트워크', depth1: '', depth2: '인사관리', depth3: '', depth4: '', depth5: '', screenName: '', screenId: '', path: '/views/lpo/PC-LPO-0714', status: '대기' },
  { id: 144, category: '스마트워크', depth1: '', depth2: '', depth3: '상세내역', depth4: '', depth5: '', screenName: '인사관리 화면', screenId: 'PC-LPO-0801', path: '/views/lpo/PC-LPO-0801', status: '대기' },
  ...
  { id: 152, category: '스마트워크', depth1: '', depth2: '', depth3: '간이 범죄예방진단', depth4: '목록', depth5: '', screenName: '간이 범죄예방진단 목록', screenId: 'PM-PUB-0101', path: '/views/pub/', status: '대기' },
