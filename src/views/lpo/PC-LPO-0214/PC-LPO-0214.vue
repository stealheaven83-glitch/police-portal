  ...
  <div class="lp-page-scroll">
    ...
    <div class="lp-row-between lp-table-gap">
      <span class="lp-filter-row lp-filter-row-tight">
        ...
        <span class="group-gap2">
          <InputField2 v-model="shiftCount" size="sm" input-class="w-20" aria-label="교대" />
          <span class="lp-label-text">교대</span>
        </span>
        <span class="group-gap2">
          <InputField2 v-model="dayCycle" size="sm" input-class="w-20" aria-label="일 주기" />
        ...
        <p class="lp-mark-note lp-mark-note-sm">
          ...
          <span>2026-01-01에 설정한 4조 2교대 4일 주기가 적용되어 있습니다.</span>
        </p>
      </span>
    ...
    <div class="section-bar lp-bar-gap">
    ...
    <div class="lp-filter-row lp-bar-body-gap">
      <span class="group-gap2">
...
const shiftColumns: TabulatorGridColumn[] = [
  ...
  { title: '근무형태', field: 'name', cellType: 'input' },
