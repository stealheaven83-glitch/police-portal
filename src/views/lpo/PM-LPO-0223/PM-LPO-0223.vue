...
const columns: TabulatorGridColumn[] = [
  ...
  // 조회 화면이라 두 칸 모두 표시 전용이다. 체크는 Tabulator 기본 tickCross(값이 false 면 빈칸),
  // 파일은 Figma 와 같은 클립 아이콘(assets/images/icons/attach.svg)을 그린다.
  {
    title: '인수인계',
    field: 'handover',
    hozAlign: 'center',
  ...
  },
  {
    ...
    formatter: (cell: { getValue: () => boolean }) =>
      cell.getValue() ? '<img src="/portal/asset/images/icon/ico_attach_24.svg" alt="첨부파일 있음" width="16" height="16">' : '',
  },
  {
    title: '상세',
    field: 'hasDetail',
