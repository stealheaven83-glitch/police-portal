...
function createMockRows(): WorkLogRow[] {
  return [
    ...
    },
    {
      ...
      time: '09:10',
      kind: '피해자보호',
      activity: '[매물릭] 중부32호 근무자 경장 고길동 경장 조택주 탄력순찰 실시\n112신고 다발지역가 범죄 예방 및 112신고',
      writer: '경감 홍길동',
      handlers: '조택주, 박광인, 싸이, 불사조',
      handover: false,
      hasFile: true,
...
export function useWorkLogWrite() {
  ...
  const handlerRows = ref<HandlerRow[]>([
    { id: 1, rank: '경감', name: '홍길동', picked: true },
    { id: 2, rank: '경사', name: '김순인', picked: true },
    { id: 3, rank: '경위', name: '조택주', picked: false },
    { id: 4, rank: '경장', name: '박광인', picked: false },
  ])
  ...
  function addRow() {
    ...
    rows.value = [
      ...rows.value,
      { id: nextId, time: '', kind: '', activity: '', writer: '', handlers: '', handover: false, hasFile: false, hasDetail: false },
    ]
  }
