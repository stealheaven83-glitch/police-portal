...
import { useBoard1501List } from './composable/PM-COM-1501'
import {
  boardMenu,
  BOARD_SPECS,
  useBoardStore,
...
// LNB: 게시판 > 교육자료 나눔터 > 상시학습자료 (presets.ts 에 게시판 메뉴가 아직 없어 도메인 composable 의 구성을 쓴다)
...
function onDeleteSelected() {
  if (!selectedCount.value) {
    toast.warning('삭제할 학습자료를 선택해 주세요.')
    return
  }
