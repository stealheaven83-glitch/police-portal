<template>
  ...
  <div class="lp-page-scroll">
    <div class="lp-narrow-form">
      <!-- 시안: 작성자 줄 오른쪽 끝에 '공지' 체크박스가 온다(1004 의 중요공지 토글 줄이 없다) -->
...
import { useStudyCreate } from './composable/PM-COM-0708'
...
const { form, writer, writtenAt, dept, fileCount, canSave, addFiles, removeFile } = useStudyCreate()
...
useBottomTabSetup({
  value: 'PM-COM-0708',
  label: `${spec.title} 등록`,
  path: '/views/com/PM-COM-0708',
  componentName: 'PmCom0708',
  closable: true,
})
</script>
