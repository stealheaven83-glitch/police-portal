...
import { useLawList, type LawRow } from './composable/PM-COM-1601'
import {
  boardMenu,
  useBoardStore,
  authorFilterOptions,
...
useBottomTabSetup({
  value: 'PM-COM-1601',
  label: '법령 · 지침 · 매뉴얼',
  path: '/views/com/PM-COM-1601',
  componentName: 'PmCom1601',
  closable: true,
})
</script>
