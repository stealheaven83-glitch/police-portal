...
import { useTipCreate } from './composable/PM-COM-0716'
...
const { form, writer, writtenAt, fileCount, canSave, addFiles, removeFile } = useTipCreate()
...
useBottomTabSetup({
  value: 'PM-COM-0716',
  label: '현장대응팁 등록',
  path: '/views/com/PM-COM-0716',
  componentName: 'PmCom0716',
  closable: true,
})
</script>
