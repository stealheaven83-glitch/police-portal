...
import { useTrainingCreate } from './composable/PM-COM-0704'
...
const { form, writer, writtenAt, dept, fileCount, canSave, addFiles, removeFile } = useTrainingCreate()
...
useBottomTabSetup({
  value: 'PM-COM-0704',
  label: `${spec.title} 등록`,
  path: '/views/com/PM-COM-0704',
  componentName: 'PmCom0704',
  closable: true,
})
</script>
