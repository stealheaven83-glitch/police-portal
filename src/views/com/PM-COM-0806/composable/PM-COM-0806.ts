/* 임시 화면ID: 기획서(범죄예방진단 V 1.2)의 PM-COM-0801~0804 가 기존 PM-COM-0801·0802(통합검색)와 화면ID가 중복돼 PM-COM-0803~0806 으로 임시 작업했다. 이 파일 = 기획서 PM-COM-0804(등록). 화면ID 확정 후 폴더·라우트·워크리스트·board.ts 를 함께 바꿀 것. */
import { computed, reactive } from 'vue'
import type { DepartmentValue } from '@/components/custom/select/DepartmentCascadeSelect.vue'
import { createEmptyBoardForm, type BoardFile, type BoardPostForm } from '../../composable/board'

/**
 * 범죄예방진단 등록(PM-COM-0806) 화면 상태.
...
export function useCptedCreate() {
