...
export const boardMenu: SideMenuConfig = {
  ...
  items: [
    ...
    {
      name: '자료실',
      children: [{ name: '범죄예방진단', path: '/views/com/PM-COM-0803' }],
    },
    {
      name: '교육자료 나눔터',
      children: [
        ...
        { name: '현장대응팁', path: '/views/com/PM-COM-0713' },
      ],
    },
    {
      name: '현장공감 TalkTalk',
      children: [
        { name: '경찰청 주요 정책', path: '/views/com/PM-COM-0901' },
        { name: '정책 제안 및 건의사항', path: '/views/com/PM-COM-0905' },
      ],
    },
  ],
}
...
export const BOARD_SPECS: Record<BoardKey, BoardSpec> = {
  ...
  tip: {
    ...
    /* 사용자 지정: 교육훈련 우수사례(training)와 같은 이유로 기획서의 07xx 를 쓴다.
       screen-id-map.md 와 Figma 시안 프레임 이름은 PM-COM-1701~1704 라 서로 다르다 — IA 확인 필요. */
    listId: 'PM-COM-0713',
    detailId: 'PM-COM-0714',
    editId: 'PM-COM-0715',
    createId: 'PM-COM-0716',
    hasPinned: false,
    hasOpenState: false,
    hasCategory: false,
    hasDept: false,
  ...
  cpted: {
    ...
    /* 사용자 지정(임시): 기획서(V 1.2)는 PM-COM-0801~0804 인데 기존 PM-COM-0801·0802(통합검색)와 중복돼 0803~0806 으로 임시 작업.
       screen-id-map.md 와 Figma 시안 프레임 이름은 PM-COM-1901~1904 — 화면ID 확정 필요. */
    listId: 'PM-COM-0803',
    detailId: 'PM-COM-0804',
    editId: 'PM-COM-0805',
    createId: 'PM-COM-0806',
    hasPinned: true,
    hasOpenState: false,
    hasCategory: false,
    hasDept: true,
  ...
  policePlan: {
    ...
    /* 사용자 지정: 교육자료 나눔터(training 등)와 같은 이유로 기획서(V 1.2)의 09xx 를 쓴다.
       screen-id-map.md 와 Figma 시안 프레임 이름은 PM-COM-2001~2004 라 서로 다르다 — IA 확인 필요. */
    listId: 'PM-COM-0901',
    detailId: 'PM-COM-0902',
    editId: 'PM-COM-0903',
    createId: 'PM-COM-0904',
    hasPinned: true,
    hasOpenState: false,
    hasCategory: false,
    hasDept: false,
  ...
  proposal: {
    ...
    /* 사용자 지정: 교육자료 나눔터(training 등)와 같은 이유로 기획서(V 1.2)의 09xx 를 쓴다.
       screen-id-map.md 와 Figma 시안 프레임 이름은 PM-COM-2101~2104 라 서로 다르다 — IA 확인 필요. */
    listId: 'PM-COM-0905',
    detailId: 'PM-COM-0906',
    editId: 'PM-COM-0907',
    createId: 'PM-COM-0908',
    hasPinned: true,
    hasOpenState: true,
    hasCategory: false,
    hasDept: false,
