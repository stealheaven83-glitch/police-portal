  ...
  >
    ...
    <InfoTable :columns="1">
      ...
      <InfoField>
        ...
        <RadioGroup v-model="detailForm.target" :class="infoStyles['info-table-radio']">
          <RadioGroupItem
    ...
    <!-- 본문은 라벨 칸 없이 표 폭을 통째로 쓴다(시안의 에디터 영역) -->
    ...
    <InfoTable :columns="1">
      ...
      <InfoField>
        ...
        <!-- '가로 [ ] px' 는 한 덩어리로 붙어 다녀야 해서 묶는다(InfoField 는 wrap 된다) -->
        <span class="group-gap2">
          <InputField2
