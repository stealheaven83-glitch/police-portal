...
import { useStudyEdit } from './composable/PM-COM-1503'
...
const { form, writer, writtenAt, dept, canSave, addFiles, removeFile } = useStudyEdit()
 ...
 * 제목이 없는 경우는 버튼 자체가 비활성(등록 시안 PM-COM-1504 와 같은 규칙)이라 여기까지 오지 않는다.
...
useBottomTabSetup({
  value: 'PM-COM-1503',
  label: '상시학습자료 수정',
  path: '/views/com/PM-COM-1503',
  componentName: 'PmCom1503',
  closable: true,
})
</script>
