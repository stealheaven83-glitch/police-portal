...
import { useLawCreate } from './composable/PM-COM-1604'
...
const { form, writer, writtenAt, canSave, addFiles, removeFile } = useLawCreate()
...
useBottomTabSetup({
  value: 'PM-COM-1604',
  label: '법령 · 지침 · 매뉴얼 등록',
  path: '/views/com/PM-COM-1604',
  componentName: 'PmCom1604',
  closable: true,
})
</script>
