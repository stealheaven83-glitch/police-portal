...
/**
 * 정책 제안 및 건의사항 목록(PM-COM-0905) 한 줄.
 *
 * 칸 구성: 부서 X / 공지 고정 O / 추천수 X / 공개상태 O / 카테고리 X.
 * 상세·수정·등록(PM-COM-0906~0712)은 `useBoardStore('proposal')` 의 상태를 쓰고,
...
function createMockRows(): ProposalRow[] {
...
export function useProposalList() {
  ...
  const allRows = ref<ProposalRow[]>(createMockRows())
