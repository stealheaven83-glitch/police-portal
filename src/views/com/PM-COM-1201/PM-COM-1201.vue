...
import { useBoard1201List } from './composable/PM-COM-1201'
import {
  boardMenu,
  BOARD_SPECS,
  useBoardStore,
...
const spec = BOARD_SPECS.policyCase

// LNB: 게시판 > 우수사례 > 지역경찰 시책 (presets.ts 에 게시판 메뉴가 아직 없어 도메인 composable 의 구성을 쓴다)
...
const { selectPost } = useBoardStore('policyCase')
...
useBottomTabSetup({
  value: 'PM-COM-1201',
  label: '지역경찰 시책',
  path: '/views/com/PM-COM-1201',
  componentName: 'PmCom1201',
  closable: true,
})
</script>
