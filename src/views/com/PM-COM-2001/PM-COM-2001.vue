...
import { usePolicyList, type PolicyRow } from './composable/PM-COM-2001'
import {
  boardMenu,
  useBoardStore,
  authorFilterOptions,
...
useBottomTabSetup({
  value: 'PM-COM-2001',
  label: '경찰청 주요 정책',
  path: '/views/com/PM-COM-2001',
  componentName: 'PmCom2001',
  closable: true,
})
</script>
