...
import { useBoard2001List } from './composable/PM-COM-2001'
import {
  boardMenu,
  BOARD_SPECS,
  useBoardStore,
...
// LNB: 게시판 > 현장공감 TalkTalk > 경찰청 주요 정책 (presets.ts 에 게시판 메뉴가 아직 없어 도메인 composable 의 구성을 쓴다)
