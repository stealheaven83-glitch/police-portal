...
/** 상세(PM-COM-1302)에서 '수정'을 누르면 loadEditForm() 으로 값이 채워져 넘어온다 */
const { spec, editForm: form } = useBoardStore('fieldCase')
...
useBottomTabSetup({
  value: 'PM-COM-1303',
  label: '현장조치 수정',
  path: '/views/com/PM-COM-1303',
  componentName: 'PmCom1303',
  closable: true,
})
</script>
