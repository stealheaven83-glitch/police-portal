...
import { usePolicyCreate } from './composable/PM-COM-0904'
...
const { form, writer, writtenAt, fileCount, canSave, addFiles, removeFile } = usePolicyCreate()
...
useBottomTabSetup({
  value: 'PM-COM-0904',
  label: '경찰청 주요 정책 등록',
  path: '/views/com/PM-COM-0904',
  componentName: 'PmCom0904',
  closable: true,
})
</script>
