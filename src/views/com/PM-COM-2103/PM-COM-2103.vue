...
import { useProposalEdit } from './composable/PM-COM-2103'
 ...
 * 제목이 없는 경우는 버튼 자체가 비활성(등록 시안 PM-COM-2104 와 같은 규칙)이라 여기까지 오지 않는다.
...
useBottomTabSetup({
  ...
  path: '/views/com/PM-COM-2103',
  componentName: 'PmCom2103',
  closable: true,
})
</script>
